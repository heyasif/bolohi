...
const FAQComponent: React.FC<FAQComponentProps> = ({ faqs }) => {
  return (
    <section className="mt-6  bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
        <h2 className="mb-8 text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white">
          Frequently Asked Questions
        </h2>
        <div className="grid border-t border-gray-200 pt-8 text-left dark:border-gray-700 md:grid-cols-2 md:gap-2">
          {faqs.map((faq, index) => (
            <div key={index} className="mb-10">
              <h3 className="mb-4 flex items-center text-lg font-medium text-gray-900 dark:text-white">
                <svg
                  className="mr-2 size-5 shrink-0 text-gray-500 dark:text-gray-400"
                  fill="currentColor"
                  viewBox="0 0 20 20"
